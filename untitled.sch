...
N 440 130 440 160 {lab=AGND}
N 440 -80 440 -50 {lab=AVDD}
...
C {lab_wire.sym} 110 140 0 0 {name=p7 sig_type=std_logic lab=AGND}
C {ipin.sym} 50 10 0 0 {name=p8 lab=vin_dac}
C {lab_wire.sym} 650 -50 0 0 {name=p1 sig_type=std_logic lab=vin_dac}
C {lab_wire.sym} 530 -80 0 0 {name=p2 sig_type=std_logic lab=AVDD}
C {lab_wire.sym} 520 160 0 0 {name=p9 sig_type=std_logic lab=AGND}
C {lab_wire.sym} 110 -140 0 0 {name=p10 sig_type=std_logic lab=AVDD}
