...
N 30 -60 30 -30 {lab=0}
N -190 -90 -10 -90 {lab=#net4}
N -220 -220 -220 -120 {lab=#net4}
N -220 -160 -160 -160 {lab=#net4}
N -160 -160 -160 -90 {lab=#net4}
...
C {vsource.sym} -440 -280 0 0 {name=V1 value=3 savecurrent=false}
C {vsource.sym} -350 -280 0 0 {name=V2 value=3 savecurrent=false}
